...
def create_prompts(quest_type, question, answer_options = None):
    #if question type is valid proceed to gpt prompts. If not valid, run random answer. 
    if quest_type in question_type:
        dev_prompt = question_type[quest_type]
        ...
        return prompt_gpt(dev_prompt, question_prompt, quest_type)
    else:
...
def prompt_gpt(dev_prompt, question_prompt, quest_type):
